...
var style_optimized_visit_points1optimized_visit_points_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("visit_sequence") !== null) {
        labelText = String(feature.get("visit_sequence"));
    }
